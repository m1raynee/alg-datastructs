...
public abstract class AbstractTreeNode<T extends Comparable<T>, N extends IBaseNode<T, N>> implements IBaseNode<T, N> {
    ...
    @Override public void setKey(T key) { this.key = key; }
    @Override public N getLeft() { return left; }
    @Override public void setLeft(N node) { this.left = node; }
    @Override public N getRight() { return right; }
    @Override public void setRight(N node) { this.right = node; }
